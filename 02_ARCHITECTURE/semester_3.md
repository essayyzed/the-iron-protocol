...
- [Data Structures with Python - Complete Course](https://www.youtube.com/playlist?list=PLnd7R4Mcw3rLmfW78NJnXXaso1BNB9Kym) (Urdu, live lectures with Q&A)
- [Computer Organization and Assembly Language - Complete Course](https://www.youtube.com/watch?v=eobVpYqvMGE&list=PLnd7R4Mcw3rLmfW78NJnXXaso1BNB9Kym) (Urdu)
  - 30+ lectures (45-75 min each), live class recordings with Q&A
  - Architecture, RAM, cache, assembly, memory, interrupts, subroutines, stack
  - Deepens systems understanding, crucial for OS
